...
float SensorData_GetTempFiltered(void)
{
    xSemaphoreTake(xSensorMutex, portMAX_DELAY);
    float v = gTempFiltered;
    xSemaphoreGive(xSensorMutex);
    return v;
}
...
float SensorData_GetSoundFiltered(void)
{
    xSemaphoreTake(xSensorMutex, portMAX_DELAY);
    float v = gSoundFiltered;
    xSemaphoreGive(xSensorMutex);
    return v;
}
